...
@endsection
@section('css')
    <link rel="stylesheet" href="{{ asset('css/product_software.css') ??''}}" />
    <style>
        a {
               ...
               <div class="content-section">
                @foreach ($product as $product)
                    <form id="product_card{{ $product->id }}"
                        action="/product-manage/software/edit/{{ $product->id }}" method="post">
                        @csrf
                ...
                <form>
                    <!-- 圖片 -->
                    <div class="add-img">
                        <a href="/product-manage/software/create">
...
<script>
    ...
    function delete_img(id) {
        ...
        fetch('/product-manage/software/delete/' + id, {
                method: 'POST',
                body: formData
            })
