            ...
            <div class="main-container">
              ...
              <div class="content">
                ...
                <div class="text">
                  <h6>對客戶</h6>
                  <span
                    >深度理解客戶需求，並提供專業服務，以協助客戶優化產能</span
                  ><br />
                </div>
                <div class="text">
                  <h6>對合作夥伴</h6>
                  <span
                    >以誠信為基礎，互惠共生為目標，協力同心提供最優質的服務給客戶</span
                  ><br />
                </div>
                <div class="text">
                  <h6>對員工</h6>
                  <span
                    >提供舒適愉快的工作氛圍，與公司一同學習成長，共享榮耀</span
                  ><br />
                </div>
              </div>
            </div>
            <div class="subtittle-container">
              ...
              <div class="sbutittle">
                ...
                <div class="content">
                  <h4>追求創新</h4>
                  <span
                    >創新、解決客戶問題是我們的目標，更是我們的企業文化。公司鼓勵員工自主提升技術力和提升團隊合作的契合度，以達成公司年度目標</span
                  >
                </div>
              </div>
              <!-- 副標 -->
              <div class="sbutittle">
                ...
                <div class="content">
                  <h4>人才培育</h4>
                  <span
                    >員工是公司的重要資產，有計畫的培育人才公司方能永續經營。專案以團體模式運作，透過作業標準化不斷提升團隊的向心力</span
                  >
                </div>
              </div>
              <!-- 副標 -->
              <div class="sbutittle">
                ...
                <div class="content">
                  <h4>客戶滿意</h4>
                  <span
                    >重視和顧客的需求，竭盡全力的達成每項專案，以客為尊、讓客戶滿意是全公司員工對自我的要求</span
                  >
                </div>
              </div>
            </div>
