                    ...
                    <div class="sec-container">
                        <div id="formto">
                            <div class="form-input star-items">
                                ...
                                <ul>
                                    <li>
                                        <input type="radio" name="items" id="items1" value="1" />
                                        <label for="items1">主打商品1</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="items" id="items2" value="2" />
                                        <label for="items2">主打商品2</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="items" id="items3" value="3" />
                                        <label for="items3">主打商品3</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="items" id="items4" value="4"/>
                                        <label for="items4">主打商品4</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="items" id="items5" value="5"/>
                                        <label for="items5">主打商品5</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="items" id="items6" value="6"/>
