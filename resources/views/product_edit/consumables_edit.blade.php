        ...
        <div id="tittle-list-id">
            <div class="list-tittle">
                ...
                <ul>
                    ...
                    <li>
                        <div class="blue"><a href="/product-manage/consumables">耗材</a></div>
                    </li>
                    <li>
            ...
            <form action="/product-manage/consumables/update/{{ $product->id }}" method="post"
...
<script>
    function d_sec_img(id) {
        ...
        fetch('/product-manage/consumables/d_sec_img/' + id, {
                method: 'POST',
                body: formData
            })
...
<script>
    function c_sec_img(id) {
        ...
        fetch('/product-manage/consumables/c_sec_img/' + id, {
            method: 'POST',
            body: formData
        })
